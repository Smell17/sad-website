        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="form-group">
                    ...
                    <input required name="txt_edit_uname" id="txt_edit_uname" class="form-control input-sm" type="text" value="'.$row['username'].'" />
                </div>
                <div class="form-group">
                    <label>Password: </label>
                    <input required name="txt_edit_pass" id="txt_edit_pass" class="form-control input-sm" type="password" minlength="9" value="'.$row['password'].'" />
                </div>
            </div>
        </div>
        </div>
